...
3. 
4. `EDA_MODELLING.ipynb`: Focuses on analyzing the trends of laboratory markers, testing their association with bipolar disorder, and applying statistical modeling to validate these associations.
---
